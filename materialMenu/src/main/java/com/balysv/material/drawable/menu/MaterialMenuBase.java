...
/**
 * Base class for ActionBar implementations of
 * {@link com.balysv.material.drawable.menu.MaterialMenuDrawable}
 * 
...
public abstract class MaterialMenuBase implements MaterialMenu {
	...
	public final void animateTouch() {
		getDrawable().animateTouch();
	}
	 ...
	 * {@link #animatePressedState(IconState)}
	 * 
