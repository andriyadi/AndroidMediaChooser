 ...
 * {@link com.balysv.material.drawable.menu.MaterialMenuDrawable} as an
...
public class MaterialMenuIcon extends MaterialMenuBase {
	...
	public MaterialMenuIcon(Activity activity, int color, int transformDuration, int pressedDuration) {
		drawable = new MaterialMenuDrawable(activity, color, DEFAULT_SCALE, transformDuration,
				pressedDuration);
...
//		view.setPadding(view.getPaddingLeft(), view.getPaddingTop(), 120, view.getPaddingBottom());
