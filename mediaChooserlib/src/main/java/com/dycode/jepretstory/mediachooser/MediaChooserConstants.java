...
public class MediaChooserConstants {
	 ...
	 */
	public static String folderName = "JepretStoryCaptures";
	...
	public static int VIDEO_DURATION_LIMIT_IN_SECOND = 15;
	public static boolean ENFORCE_VIDEO_DURATION_LIMIT = false;
