...
public class CustomImageView extends ImageView {
	...
	public CustomImageView(Context context, AttributeSet attrs) {
		...
		try {
			mMatchHeightToWidth = a.getBoolean(
					R.styleable.CustomView_matchHeightToWidth, false);
			mMatchWidthToHeight = a.getBoolean(
					R.styleable.CustomView_matchWidthToHeight, false);
		} finally {
			a.recycle();
		}
	}
