...
public class BucketGridAdapter extends ArrayAdapter<BucketEntry> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(mIsFromVideo){
			new VideoLoadAsync(bucketVideoFragment, holder.imageView, false, mWidth/3, mWidth/3).executeOnExecutor(MediaAsync.THREAD_POOL_EXECUTOR, mBucketEntryList.get(position).bucketUrl.toString());
